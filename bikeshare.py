...
def city_input():
    ...
    print("Please enter the city you want to analyze it's data:")
    print(' Chicago: 1')
    print(' New York: 2')
    print(' Washington: 3')
    print(' ')
    city = input(" Can you please choose the demanded city you want to see it's Statistics: ")
    city = city.lower()
    while True:  # for handling the unexpected input by user
        if city == '1' or city == 'chicago':
            print("\n Chicago City! Let's continue please \n")
            return 'chicago'
        if city == '2' or city == 'new york':
            print("\n New York City! Let's continue please \n")
            return 'new york city'
        elif city == '3' or city == 'washington':
            print("\n Washington! Let's continue please \n")
            return 'washington'
        # error handled by implementing 'else'
        else:
            print('\n Please choose 1, 2 or 3 or the names of cities \n')
            city = input("Can you please choose the demanded city you want to see it's Statistics : ")
            city = city.lower()
    return city
...
def get_time():
    ...
    '''
    period = input(
        "\n Do you want to filter your data by month and day of month, day of week, or you don't want to filter it at all? Type 'no' for no period filter. \n")
    period = period.lower()
    ...
    while True:
        if period == "month":
            while True:
                day_month = input(
                    "\n Do you want to filter the data by day of month also? Type 'YES' or 'NO' \n").lower()
                if day_month == "no":
                    print('\n The data is now filtered by month\n')
                    return 'month'
                elif day_month == "yes":
                    print('\n The data is now filtered by month and day of month \n')
                    return 'day_of_month'

        if period == "day":
            print("\n The data is now filtered by the day of week \n")
            return 'day_of_week'
        elif period == "no":
            print("\n No period filter is applied to data \n")
            return "none"
        period = input(
...
def month_freq(df):
    ...
    print(" \n # Question no.1 - What is the most popular month for bike traveling?")
    m = df.month.mode()[0]
    months = ['january', 'february', 'march', 'april', 'may', 'june']
...
def day_freq(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print(" \n # Question no.2 - What is the most popular day of the week for bike rides?")
...
def hour_freq(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print(" \n # Question no.3 - What is the most popular hour of the day for bike rides?")
...
def ride_duration(df):
    ...
    # df - dataframe returned from time_filters
    print(
        " \n # Question no.4 - What was the total traveling done for 2017 through June, and what was the average time spent on each trip? ")
    ...
    print(" Average travel time on 2017 through June was " + avg_days + " days \n ")
...
def stations_freq(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print(" \n # Question no.5 - What is the most popular start station?\n ")
    start_station = df['Start Station'].value_counts().reset_index()['index'][0]
    print(start_station)
    print(" \n # Question no.6 - What is the most popular end station?\n ")
...
def common_trip(df):
    ...
    print(" \n # Question no.7 - What was the most popular trip from start to end? ")
    return result
...
def bike_users(df):
    ...
    '''
    # df - dataframe returned from time_filters
    print(" \n # Question no.8 - Types of users: subscribers, customers, others\n ")
...
def gender_data(df):
    ...
    # df - dataframe returned from time_filters
    try:
        print(" \n # Question no.9 - What is the breakdown of gender among users?\n ")
...
def birth_years(df):
    ...
    # df - dataframe returned from time_filters
    try:
        print(" \n # Question no.10 - What is the earliest, latest, and most frequent year of birth, respectively? ")
